...
| index                        | Define the name of the index column of the data to link the exposure CSV file with the exposure vector file.                                                                 | Yes                                 | 'Object ID'                                                               | 'Object ID'                               |
| **[exposure.grid]**          |                                                                                                                                                                              |                                     |                                                                           |                                           |
...
Below we present an example of what a *settings.toml* could look like for a case that considers the required fields only:
